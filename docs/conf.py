# -*- coding: utf-8 -*-
#
# pytest-changed documentation build configuration file, created by
...
project = u'pytest-changed'
copyright = u'2015, Gastrofix GmbH'
author = u'Gastrofix GmbH'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-changed Documentation',
     [author], 1)
]
